...
function generateBarcodeImage(productCode, priceInPence) {
    try {
        ...
        // Add BlackSite watermark
        ctx.fillStyle = '#666';
        ctx.font = '10px Arial';
        ctx.textAlign = 'center';
        ctx.fillText('Generated by BlackSite', 200, 145);
...
client.once('clientReady', async () => {
    console.log(`🤖 BlackSite Barcode Bot is online as ${client.user.tag}!`);
...
// Export for deployment (replace with your bot token)
module.exports = { client };

// For local development - uncomment and add your token
